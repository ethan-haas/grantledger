  ...
  return (
    <div className="flex min-h-[50vh] items-center justify-center p-8">
      <Card className="max-w-md text-center">
        ...
        <h2 className="text-lg font-semibold font-display tracking-tight text-slate-900 dark:text-slate-100">Unable to load grant</h2>
        <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
          We couldn&apos;t load this grant. It may have been deleted or you may not have access.
        </p>
        {error.digest && (
          <p className="mt-1 text-xs text-slate-400">Error ID: {error.digest}</p>
        )}
        <div className="mt-6 flex justify-center gap-3">
          <Button variant="secondary" onClick={() => window.location.href = "/dashboard/grants"}>
            Back to Grants
          </Button>
